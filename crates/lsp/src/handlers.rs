...
pub(crate) fn completion(
    ...
    let Some(completion_list) = snap.analysis.completion(source_unit_id, pos, trigger_char) else {
        return Ok(None);
    };
...
pub(crate) fn hover(snap: ServerSnapshot, params: HoverParams) -> Result<Option<Hover>> {
